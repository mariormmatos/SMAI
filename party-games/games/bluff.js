...
const QUESTIONS = [
  ...
  'Já fiz as pazes com alguém só porque estava com saudades, não porque tinha perdoado.',
  'Já fingi que percebia uma piada que não percebi.',
  'Já dormiu com roupa do dia interior.',
  'Já demorei mais de 1 hora a escolher o que ver antes de adormecer.',
  'Já fiz compras online às 3 da manhã.',
  'Já bloqueei alguém nas redes sociais por ciúmes.',
  'Já menti sobre a minha idade.',
  'Já comi a sobremesa antes do prato principal.',
  'Já passei um fim de semana inteiro sem sair de casa.',
  'Já inventei uma história impressionante sobre mim para conhecidos.',
  'Já guardei segredo de alguém que não merecia.',
  'Já fiz "unfollow" a alguém por excesso de partilhas de bebés/gatos.',
  'Já fui a um concerto de um artista que não gosto por não ter outra escolha.',
  'Já copiei numa prova ou exame.',
  'Já fiz uma compra por impulso e me arrependi no dia seguinte.',
  'Já chorei a ouvir uma música.',
  'Já mandei mensagem errada ao namorado/a ou crush.',
  'Já fiz like numa foto antiga no Instagram de alguém sem querer.',
  'Já comi comida de outra pessoa no frigorífico da empresa.',
  'Já fingi não ver um conhecido na rua para não ter de falar.',
  'Já pedi desculpa sem me sentir culpado/a.',
  'Já acordei com o alarme e voltei a dormir mais de 3 vezes.',
  'Já recusei empréstimo de dinheiro a amigo/a.',
  'Já bati com o carro e não deixei nota.',
  'Já fiz fila no sítio errado e não disse nada quando percebi.',
  'Já espreitei o telemóvel de alguém.',
  'Já fingi gostar de uma prenda horrível.',
  'Já me esqueci do aniversário de alguém importante.',
  'Já falei sobre um colega de trabalho nas costas dele.',
  'Já usei as meias ao contrário sem querer.',
  'Já enviei um email importante para o lixo por engano.',
  'Já fingi ter lido um livro que nunca li.',
  'Já fiz uma festa surpresa que correu muito mal.',
  'Já passei um dia sem falar com ninguém por escolha.',
  'Já apanhei alguém a mentir e não disse nada.',
  'Já roubei caneta ou material de escritório do trabalho.',
  'Já assinei uma petição sem a ler.',
  'Já dancei sozinho/a em frente ao espelho.',
  'Já fui às compras com fome e comprei o dobro do necessário.',
  'Já tirei foto à refeição antes de comer.',
  'Já escolhi um restaurante pela decoração e não pela comida.',
  'Já parti uma promessa que fiz a mim mesmo/a.',
  'Já inventei uma alergia para evitar uma comida.',
  'Já cantei o hino nacional errado.',
  'Já fiz scroll no telemóvel durante uma conversa.',
  'Já fui ao cinema ver um filme diferente do que disse.',
  'Já comprei roupa que sabia que nunca ia usar.',
  'Já passei mais de 2 horas no WC por causa do telemóvel.',
  'Já fiz spoiler de uma série sem querer.',
  'Já escolhi o amor pelo dinheiro (ou vice-versa).',
  'Já fingi estar a dormir para não atender uma chamada.',
  'Já usei um cupão de desconto de outra pessoa sem pedir.',
  'Já espreitei o resultado de um exame antes de estar pronto.',
  'Já fiz uma selfie numa casa de banho pública.',
  'Já agi como se soubesse de algo e pesquisei depois.',
  'Já menti sobre o meu peso ou altura.',
  'Já desisti de uma dieta no primeiro dia.',
];
